...
#ifndef NATIVEUI_GFX_GEOMETRY_RECT_F_H_
#define NATIVEUI_GFX_GEOMETRY_RECT_F_H_
...
NATIVEUI_EXPORT RectF IntersectRects(const RectF& a, const RectF& b);
NATIVEUI_EXPORT RectF UnionRects(const RectF& a, const RectF& b);
NATIVEUI_EXPORT RectF SubtractRects(const RectF& a, const RectF& b);
...
NATIVEUI_EXPORT RectF BoundingRect(const PointF& p1, const PointF& p2);
...
#endif  // NATIVEUI_GFX_GEOMETRY_RECT_F_H_
